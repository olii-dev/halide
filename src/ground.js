...
export class Ground {
  constructor(renderer, scene) {
    ...
    mat.userData.uniforms = {
      tAO: { value: this.rtA.texture }, aoExtent: { value: this.extent },
    ...
    mat.onBeforeCompile = (sh) => {
      ...
      sh.fragmentShader = sh.fragmentShader
        .replace('void main() {', `varying vec3 vWorldP; uniform sampler2D tAO; uniform float aoExtent, sunShare, aoStrength, contactStrength, carYaw; uniform vec2 carPos;
void main() {`)
