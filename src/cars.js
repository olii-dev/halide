...
export const MODELS = [
  ...
  { id: 'sl300', name: 'Mercedes-Benz 300 SL Gullwing', year: 1954, file: 'sl300.glb', tire: ['tire'], merged: ['chrome', 'mid-chrome', 'black'], paint: ['main_color'], hide: [], glass: { Material: 0.88 }, head: ['Material'], length: 4.52, front: '+z',
