...
export const LOCATIONS = [
  ...
  { id: 'goegap_road', dust: '#a57a5c', name: 'Goegap', place: 'Desert road, Namaqualand', height: 1.7, u: 0.462, kind: 'nature' },
  ...
  { id: 'mealie_road', dust: '#a88f6e', name: 'Mealie Road', place: 'Farm road, golden hour', height: 1.7, u: 0.62, kind: 'nature' },
  { id: 'lonely_road_afternoon', dust: '#a88f6e', name: 'Lonely Road', place: 'Farm road, late sun', height: 1.7, u: 0.0, kind: 'nature' },
  ...
  { id: 'signal_hill_sunrise', name: 'Signal Hill', place: 'Mountain road, Cape Town, sunrise', height: 1.7, u: 0.995, iconic: true, kind: 'nature' },
