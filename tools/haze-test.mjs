...
await p.evaluate(async M => { document.body.classList.remove('in-menu'); await halide.setCarModel(halide.cars[0], M); halide.cars[0].s.rot = 30; halide.markDirty(); }, process.env.M || 'bmwm3e30');
